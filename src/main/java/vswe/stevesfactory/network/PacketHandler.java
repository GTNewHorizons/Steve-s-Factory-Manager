...
public class PacketHandler {
    ...
    /*
     * public static void readBlockPacket(DataReader data) { int x = data.readData(DataBitHelper.WORLD_COORDINATE); int
     * y = data.readData(DataBitHelper.WORLD_COORDINATE); int z = data.readData(DataBitHelper.WORLD_COORDINATE); World
     * world = Minecraft.getMinecraft().theWorld; if (world.getBlockId(x, y, z) == Blocks.blockCable.blockID) {
