...
public final class ModBlocks {
    ...
    public static void init() {
        ...
        ClusterRegistry.register(
                new ClusterRegistry.ClusterRegistryAdvancedSensitive(
                        TileEntityRelay.class,
                        blockCableRelay,
        ...
        ClusterRegistry.register(
                new ClusterRegistry.ClusterRegistryAdvancedSensitive(
                        TileEntityIntake.class,
                        blockCableIntake,
                        new ItemStack(blockCableIntake, 1, 8)));
        ...
        ClusterRegistry.register(
                new ClusterRegistry.ClusterRegistryMetaSensitive(
                        TileEntityCamouflage.class,
    ...
    public static void addRecipes() {
        ...
        if (!Loader.isModLoaded("dreamcraft")) {
            ...
            GameRegistry.addShapelessRecipe(
                    new ItemStack(blockCableOutput, 1),
                    blockCable,
                    Items.redstone,
                    Items.redstone,
                    Items.redstone);
            ...
            GameRegistry.addShapelessRecipe(
                    new ItemStack(blockCableBreaker, 1),
                    blockCable,
                    Items.iron_pickaxe,
                    Blocks.dispenser);
            ...
            GameRegistry.addShapelessRecipe(
                    new ItemStack(blockCableSign, 1),
                    blockCable,
