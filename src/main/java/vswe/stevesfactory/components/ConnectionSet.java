...
public enum ConnectionSet {
    ...
    REDSTONE(
            Localization.CONNECTION_SET_REDSTONE,
            ConnectionOption.REDSTONE_PULSE_HIGH,
            ConnectionOption.REDSTONE_HIGH,
            ConnectionOption.REDSTONE_LOW,
            ConnectionOption.REDSTONE_PULSE_LOW),
    STANDARD_CONDITION(
            Localization.CONNECTION_SET_CONDITION,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.CONDITION_TRUE,
            ConnectionOption.CONDITION_FALSE),
    MULTIPLE_INPUT_2(
            Localization.CONNECTION_SET_COLLECTOR_2,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_OUTPUT),
    MULTIPLE_INPUT_5(
            Localization.CONNECTION_SET_COLLECTOR_5,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_INPUT,
            ...
            ConnectionOption.STANDARD_OUTPUT),
    MULTIPLE_OUTPUT_2(
            Localization.CONNECTION_SET_SPLIT_2,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_OUTPUT,
            ConnectionOption.STANDARD_OUTPUT),
    MULTIPLE_OUTPUT_5(
            Localization.CONNECTION_SET_SPLIT_5,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.STANDARD_OUTPUT,
            ConnectionOption.STANDARD_OUTPUT,
            ConnectionOption.STANDARD_OUTPUT,
    ...
    FOR_EACH(
            Localization.CONNECTION_SET_FOR_EACH,
            ConnectionOption.STANDARD_INPUT,
            ConnectionOption.FOR_EACH,
            ConnectionOption.STANDARD_OUTPUT),
    BUD(
            Localization.CONNECTION_SET_BUD,
            ConnectionOption.BUD_PULSE_HIGH,
            ConnectionOption.BUD_HIGH,
            ConnectionOption.BUD,
            ConnectionOption.BUD_LOW,
            ConnectionOption.BUD_PULSE_LOW),
    ...
    DYNAMIC(
            Localization.CONNECTION_SET_DYNAMIC,
            ConnectionOption.DYNAMIC_INPUT,
            ConnectionOption.DYNAMIC_INPUT,
            ConnectionOption.DYNAMIC_INPUT,
            ConnectionOption.DYNAMIC_INPUT,
            ConnectionOption.DYNAMIC_INPUT,
            ConnectionOption.DYNAMIC_OUTPUT,
            ConnectionOption.DYNAMIC_OUTPUT,
            ConnectionOption.DYNAMIC_OUTPUT,
            ConnectionOption.DYNAMIC_OUTPUT,
            ConnectionOption.DYNAMIC_OUTPUT),
