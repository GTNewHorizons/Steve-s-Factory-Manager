...
public final class ModBlocks {
    ...
    public static void init() {
        ...
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryAdvancedSensitive(
                TileEntityRelay.class, blockCableRelay, new ItemStack(blockCableRelay, 1, 0)));
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryAdvancedSensitive(
                TileEntityRelay.class, blockCableRelay, new ItemStack(blockCableRelay, 1, 8)));
        ...
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryAdvancedSensitive(
                TileEntityIntake.class, blockCableIntake, new ItemStack(blockCableIntake, 1, 0)));
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryAdvancedSensitive(
                TileEntityIntake.class, blockCableIntake, new ItemStack(blockCableIntake, 1, 8)));
        ...
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryMetaSensitive(
                TileEntityCamouflage.class, blockCableCamouflage, new ItemStack(blockCableCamouflage, 1, 0)));
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryMetaSensitive(
                TileEntityCamouflage.class, blockCableCamouflage, new ItemStack(blockCableCamouflage, 1, 1)));
        ClusterRegistry.register(new ClusterRegistry.ClusterRegistryMetaSensitive(
                TileEntityCamouflage.class, blockCableCamouflage, new ItemStack(blockCableCamouflage, 1, 2)));
    ...
    public static void addRecipes() {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(blockCableRelay, 1), blockCable, Blocks.hopper);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableOutput, 1), blockCable, Items.redstone, Items.redstone, Items.redstone);

        GameRegistry.addShapelessRecipe(new ItemStack(blockCableInput, 1), blockCable, Items.redstone);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableRelay, 1, 8),
                new ItemStack(blockCableRelay, 1, 0),
                new ItemStack(Items.dye, 1, 4));

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableIntake, 1, 0), blockCable, Blocks.hopper, Blocks.hopper, Blocks.dropper);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableBUD, 1), blockCable, Items.quartz, Items.quartz, Items.quartz);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableBreaker, 1), blockCable, Items.iron_pickaxe, Blocks.dispenser);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableIntake, 1, 8), new ItemStack(blockCableIntake, 1, 0), Items.gold_ingot);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableCluster, 1),
                blockCable,
                Items.ender_pearl,
                Items.ender_pearl,
                Items.ender_pearl);
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableCamouflage, 1, 2),
                new ItemStack(blockCableCamouflage, 1, 1),
                Blocks.sticky_piston);

        GameRegistry.addShapelessRecipe(
                new ItemStack(blockCableSign, 1), blockCable, new ItemStack(Items.dye, 0), Items.feather);
