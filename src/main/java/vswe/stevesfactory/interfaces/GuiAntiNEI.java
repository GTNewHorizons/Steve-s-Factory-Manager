...
public abstract class GuiAntiNEI extends GuiScreen {
    ...
    private void func_146977_a(Slot p_146977_1_) {
        ...
        if (p_146977_1_ == this.clickedSlot
    ...
    private void func_146980_g() {
        ...
        if (itemstack != null && this.field_147007_t) {
            ...
            for (Iterator iterator = this.field_147008_s.iterator();
                    iterator.hasNext();
                    this.field_146996_I -= itemstack1.stackSize - i) {
    ...
    protected void mouseClicked(int par1, int par2, int par3) {
        ...
        this.field_146993_M =
                this.field_146998_K == slot && l - this.field_146997_J < 250L && this.field_146992_L == par3;
    ...
    protected void mouseMovedOrUp(int p_146286_1_, int p_146286_2_, int p_146286_3_) {
        ...
        int i1 = this.guiTop;
        boolean flag =
                p_146286_1_ < l || p_146286_2_ < i1 || p_146286_1_ >= l + this.xSize || p_146286_2_ >= i1 + this.ySize;
        int j1 = -1;
    ...
    protected boolean func_146978_c(
            int p_146978_1_, int p_146978_2_, int p_146978_3_, int p_146978_4_, int p_146978_5_, int p_146978_6_) {
        int k1 = this.guiLeft;
        int l1 = this.guiTop;
        p_146978_5_ -= k1;
        p_146978_6_ -= l1;
    ...
    protected void handleMouseClick(Slot p_146984_1_, int p_146984_2_, int p_146984_3_, int p_146984_4_) {
        ...
        this.mc.playerController.windowClick(
                this.inventorySlots.windowId, p_146984_2_, p_146984_3_, p_146984_4_, this.mc.thePlayer);
    }
